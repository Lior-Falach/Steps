...
if __name__ == '__main__':
    ...
    covariance_estimate_k_minus = np.zeros((15, 15))*0
    ...
    while time < 20:  # i+11 < len(data):,time < 15:  #
        ...
        vx.append(optimal_state_estimate_k[6][0] * 3.6)
        vy.append(optimal_state_estimate_k[7][0] * 3.6)
        vz.append(optimal_state_estimate_k[8][0] * 3.6)
